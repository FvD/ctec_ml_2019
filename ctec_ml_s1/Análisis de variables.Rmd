...
```{r}
# Escriba su código aqui
cor(var_casas, method = "pearson")
cor(var_casas, method = "spearman")
```
...
```{r}
# Escriba su código aqui
plot(x = var_casas$sqft_living, y = var_casas$price, main = "Relación entre precio y metros cuadrados", 
     xlab = "Metros Cuadrados", ylab = "Precio" )
```
